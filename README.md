...
This repository shares the starter code for the HTML assignment.

**Your Challenge:** Utilize the knowledge you have gained from the HTML classes to build a website for The Little Taco Shop.
